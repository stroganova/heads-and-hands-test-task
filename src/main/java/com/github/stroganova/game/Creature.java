...
/*
 * Абстрактный класс Creature описывает Существ. Сделан абстрактным так как, судя по описанию,
 * сами Существа являются абстракцией и не могут быть созданы в виде обЪъектов для участия в игре.
 * Содержит все общие поля и методы для своих наследников - классов Игрок и Монстр.
 ...
 * Реализованы все геттеры и сеттеры и сделаны public методами в целях тестирования приложения и возможного усложнения реализации в дальнейшем,
